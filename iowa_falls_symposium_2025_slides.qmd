...
# Who falls the most?
In the upcoming slides, we will explore fall events by patient demographic characteristics.
...
![](figures/race_gt.png){fig-alt="A statistical table showing the count of injury events by patient race group, with sparklines showing the trend from 2020-2024 and 100% bar plots." fig-align="center"}
