...
format: 
  letterbox-revealjs:
    theme: custom.scss
    footer: "Iowa Falls Prevention Symposium 2025"
...
::: notes
Remember to mention that data in this presentation pertain only to injuries that occurred in Iowa Iowa hospitals take care of patients from across our borders frequently. Overall statistics reported in the annual trauma report will vary from those reported here.
:::
...
<!-- Get population data from the CDC -->
...
<img src="figures/race_gt.png" id="swap-img" style="max-width: 75%" alt="Statistical tables showing counts of injury events by race group with and without the white race for each year 2020 through 2024. There is a 100% bar group showing the percent of total injury events by race group, and a sparkline graph in the last column showing the trend of count of injury events from 2020 through 2024.;"/><br>

```{=html}
<button style="font-family:&#39;Work Sans&#39;, sans-serif; font-weight:bold; color: #19405B;
                 background-color: #B9E1DA; border: solid #03617A;" onclick="document.getElementById(&#39;swap-img&#39;).src=&#39;figures/race_gt.png&#39;">
```
...
```{=html}
<button style="font-family:&#39;Work Sans&#39;, sans-serif; font-weight:bold; color: #19405B;
                 background-color: #B9E1DA; border: solid #03617A;" onclick="document.getElementById(&#39;swap-img&#39;).src=&#39;figures/non_white_race_gt.png&#39;">
```
...
<!-- Body region affected by falls count and gt table -->
...
<!-- Calculate RMM overall and plot -->
```{r rmm_overall}
